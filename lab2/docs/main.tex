...
class Graph:
    """表示无向图"""
    def add_node(self, label: str) -> int  # 添加节点
    def add_edge(self, u: int, v: int)     # 添加边
    def nodes(self) -> List[int]           # 获取所有节点
    def edges(self) -> List[Tuple[int, int]]  # 获取所有边
    def get_label(self, node_id: int) -> str  # 获取节点标签
\end{lstlisting}
